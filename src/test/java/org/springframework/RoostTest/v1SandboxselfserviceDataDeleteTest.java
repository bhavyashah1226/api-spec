...
Test generated for /v1/sandbox-self-service/data_delete for http method type DELETE in rest-assured framework

RoostTestHash=94c299020d
...
public class v1SandboxselfserviceDataDeleteTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/RoostTest/v1_sandbox-self-service_dataDeleteTest.csv", envVarsList);
    }

  
    @Test  
    public void v1SandboxselfserviceDataDelete_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .delete("/v1/sandbox-self-service/data")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: v1SandboxselfserviceDataDelete_Test \n", testNumber++);
              System.out.println("Request: DELETE /v1/sandbox-self-service/data");
