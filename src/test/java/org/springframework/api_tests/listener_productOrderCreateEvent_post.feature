...
Feature: Product Order Create Event By Client
  ...
  Scenario Outline: Notification with different order codes
    ...
    Examples:
      | code | description                                    |
      | -1   | O Equipamento já está em uso por outro cliente |
      | 0    | Ordem encerrada com sucesso                    |
      | 1    | Enviando Atualização de Ordem                  |
      | 2    | Ordem cancelada                                |
      | 3    | Início do Processo de Obra                     |
      | 4    | Término do Processo de Obra                    |
