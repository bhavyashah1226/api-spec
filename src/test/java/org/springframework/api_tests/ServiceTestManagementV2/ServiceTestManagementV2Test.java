  ...
  package org.springframework.api_tests.ServiceTestManagementV2;
...
String authtoken = System.getenv().getOrDefault("AUTH_TOKEN", "dummy_AUTH_TOKEN");
          Results results = Runner.path("src/test/java/org/springframework/api_tests/ServiceTestManagementV2")
